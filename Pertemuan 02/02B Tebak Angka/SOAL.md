...
### Input Format
Dua buah bilangan bulat a dan b, serta sebuah bilangan c (-2M < a,b,c < 2M).

### Output Format
Sebuah teks {kiri | tengah | kanan | tepi} sesuai dengan deskripsi soal. Output diakhiri dengan *newline*.
